...
const seveColorsPalette = () => {
  ...
  colorList.color1 = document.getElementById('color-1').style.backgroundColor;
  colorList.color2 = document.getElementById('color-2').style.backgroundColor;
  colorList.color3 = document.getElementById('color-3').style.backgroundColor;
  colorList.color4 = document.getElementById('color-4').style.backgroundColor;
  ...
  const recoveryColorList = () => {
    if (localStorage.getItem('colorPalette')) {
      ...
      document.getElementById('color-1').style.backgroundColor = status.color1;
      document.getElementById('color-2').style.backgroundColor = status.color2;
      document.getElementById('color-3').style.backgroundColor = status.color3;
      document.getElementById('color-4').style.backgroundColor = status.color4;
    }
  };
...
window.onload = () => {
  const buttonAleatorias = document.querySelector('#button-random-color');
  buttonAleatorias.addEventListener('click', randomColors);
  recoveryColorList();
